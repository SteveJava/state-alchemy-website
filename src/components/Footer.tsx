    ...
    <footer className="bg-brand-bg border-t border-white/5 py-20">
      <div className="px-6 md:px-10 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="md:col-span-2 text-center md:text-left flex flex-col items-center md:items-start">
          <Link to="/" className="flex items-center justify-center md:justify-center md:justify-start gap-2 mb-6 group">
            <img
              src="images/SAM.png"
        ...
        <div className="grid grid-cols-2 gap-8 md:col-span-2 text-center md:text-left">
          <div>
            ...
            <ul className="space-y-3 text-brand-text-muted text-sm">
              ...
              <li>
                <a
                  ...
                  className="flex items-center justify-center md:justify-start gap-2 hover:text-brand-primary transition-colors"
                >
      ...
      <div className="px-6 md:px-10 mt-20 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4 text-[10px] uppercase tracking-[0.2em] text-brand-text-muted">
