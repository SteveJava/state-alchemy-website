...
export const LiveActsPage = () => {
  return (
    <div className="pt-32">
      ...
      >
        <h1 className="text-5xl md:text-7xl font-bold uppercase tracking-tighter mb-4">Live <span className="text-gradient">Acts</span></h1>
        <p className="text-brand-text-muted max-w-2xl mx-auto px-6">
          The alchemists of live hardware and real-time sonic manipulation.
        </p>
      </motion.div>
      
      <ArtistsSection category="Live" />
